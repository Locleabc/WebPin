...
function layThongTinSanPhamTuTable(id) {
    ...
    var Capacity = tr[11].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var Cycle = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var MaxCharge = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var MaxDisCharge = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var Color = tr[15].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var Size = tr[16].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var Status = tr[17].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var Material = tr[18].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["EVE", "Samsung", "Makita", "Dewalt", "No Brand", "Batix"];
    ...
    s += `
        ...
        <tr>
            <td>Dung lượng:</td>
            <td><input type="text" value="`+sp.detail.Capacity+`"></td>
        </tr>
        <tr>
            <td>Tuổi thọ:</td>
            <td><input type="text" value="`+sp.detail.Cycle+`"></td>
        </tr>
        <tr>
            <td>Dòng xả tối đa:</td>
            <td><input type="text" value="`+sp.detail.MaxCharge+`"></td>
        </tr>
        <tr>
            <td>Dòng sạc tối đa:</td>
            <td><input type="text" value="`+sp.detail.MaxDisCharge+`"></td>
        </tr>
        <tr>
            <td>Màu sắc:</td>
        ...
        <tr>
            <td>Trạng thái:</td>
            <td><input type="text" value="`+sp.detail.Status+`"></td>
        </tr>
        <tr>
            <td>Vật liệu:</td>
