...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/1.png" alt="Trang chủ Năng Lượng Xanh 247" title="Trang chủ Năng Lượng Xanh 247">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Năng Lượng Xanh 247 </a> - All rights reserved © 2021
    </div>`);
}
        ...
        s.innerHTML = `
			(function () {
				...
				for (var li of li_s) {
					...
					switch (loai) {
						case "Dung lượng:":
							result.detail.Capacity = giatri.replace('"', "'");
							break;
						case "Tuổi thọ:":
							result.detail.Cycle = giatri;
							break;
						case "Dòng xả tối đa:":
							result.detail.MaxCharge = giatri;
							break;
						case "Dòng sạc tối đa:":
							result.detail.MaxDisCharge = giatri;
							break;
						case "Màu sắc:":
